...
import { WhirlpoolContext, WhirlpoolIx, buildWhirlpoolClient, ORCA_WHIRLPOOL_PROGRAM_ID, buildDefaultAccountFetcher, MIN_SQRT_PRICE, MAX_SQRT_PRICE, TickArrayUtil, PDAUtil, TickUtil, PriceMath, MIN_TICK_INDEX, MAX_TICK_INDEX } from '../../whirlpools/legacy-sdk/whirlpool';
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    if (req.method === 'POST') {
      try {
        ...
        const poolsResponse = await fetch('http://localhost:3000/api/whirlpools');
